		...
		<div className="mt-16 px-4">
				...
				<div className="mt-1">
					...
					{method === 'phone' ? (
						...
						<div className="flex rounded-md shadow-sm">
							<span className="flex items-center justify-center px-3 rounded-l-md border-r-0 border border-gray-300 bg-gray-50 text-sm text-gray-500 selection:none">
								+82
							</span>
							<input
								type="number"
			...
			<div className="mt-6">
				<div className="relative">
					{/* 라인 */}
					<div className="absoloute w-full border-t border-[gray]" />
					{/* 라인 중앙에 겹치도록 */}
					<div className="relative -top-3 text-center">
						<span className="bg-white px-2 text-sm text-[gray]">
							Or enter with
						</span>
					</div>
				</div>
				<div className="grid grid-cols-2 gap-3 mt-6">
					<button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white font-medium text-sm text-gray-500 hover:bg-gray-50">
						<svg
							className="w-5 h-5"
							aria-hidden="true"
							fill="currentColor"
