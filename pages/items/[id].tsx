		...
		<Layout canGoBack>
			<div className="px-4 py-10">
				<div className="mb-8">
					...
					{/* 유저 프로필 */}
					<div className="flex cursor-pointer items-center py-3 space-x-3">
					...
					<div className="mt-10">
						...
						<div className="flex items-center justify-between space-x-2">
							<button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 ring-offset-2 ring-orange-400 font-medium hover:bg-orange-600">
								Talk to seller
							</button>
